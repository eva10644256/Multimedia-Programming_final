...
<%
            String sqlmt = "SELECT * FROM goods WHERE type = 'man' AND kind='top' group by goodname ";
            ResultSet rsmt = con.createStatement().executeQuery(sqlmt);
            while(rsmt.next())
            {
                out.println("<div class='hot_box_product'>");
                out.println("<form action='product.jsp' method='post'>");
                out.println("<input type='hidden' name='search' value='"+rsmt.getString("goodname")+"'>");
                out.println("<a href='product.jsp'><input type='image' src='"+rsmt.getString("path")+"' class='img-fluid'>");
                out.println("<p>"+rsmt.getString("goodname")+"</p>");
                out.println("</a>");
                out.println("</form>");
                out.println("</div>");
            }
        %>
            <!--<div class="hot_box_product">
              <img src="img/man/m-1.jpg" class="img-fluid">
              <p>品名</p>
            </div>
            <div class="hot_box_product">
              <img src="img/man/m-2.jpg" class="img-fluid">
              <p>品名</p>
            </div>
            <div class="hot_box_product">
              <img src="img/man/m-3.jpg" class="img-fluid">
              <p>品名</p>
            </div>
            <div class="hot_box_product">
              <img src="img/man/m-4.jpg" class="img-fluid">
              <p>品名</p>
            </div>-->
      ...
      <div id="down-m">
        ...
        <div class="hot_box">
          ...
          <div class="hot_box_productbox">
          <%
            String sqlmb = "SELECT * FROM goods WHERE type = 'man' AND kind='bottom' group by goodname ";
            ResultSet rsmb = con.createStatement().executeQuery(sqlmb);
            while(rsmb.next())
            {
                out.println("<div class='hot_box_product'>");
                out.println("<form action='product.jsp' method='post'>");
                out.println("<input type='hidden' name='search' value='"+rsmb.getString("goodname")+"'>");
                out.println("<a href='product.jsp'><input type='image' src='"+rsmb.getString("path")+"' class='img-fluid'>");
                out.println("<p>"+rsmb.getString("goodname")+"</p>");
                out.println("</a>");
                out.println("</form>");
                out.println("</div>");
            }
        %>
            <!--<div class="hot_box_product">
              <img src="img/man/m-6.jpg" class="img-fluid">
              <p>品名</p>
            </div>
            <div class="hot_box_product">
              <img src="img/man/m-7.jpg" class="img-fluid">
              <p>品名</p>
            </div>
            <div class="hot_box_product">
              <img src="img/man/m-8.jpg" class="img-fluid">
              <p>品名</p>
            </div>
            <div class="hot_box_product">
              <img src="img/man/m-9.jpg" class="img-fluid">
              <p>品名</p>
            </div>-->
      ...
      <div id="coat-m">
        ...
        <div class="hot_box">
          ...
          <div class="hot_box_productbox">
          <%
            String sqlmo = "SELECT * FROM goods WHERE type = 'man' AND kind='outer' group by goodname ";
            ResultSet rsmo = con.createStatement().executeQuery(sqlmo);
            while(rsmo.next())
            {
                out.println("<div class='hot_box_product'>");
                out.println("<form action='product.jsp' method='post'>");
                out.println("<input type='hidden' name='search' value='"+rsmo.getString("goodname")+"'>");
                out.println("<a href='product.jsp'><input type='image' src='"+rsmo.getString("path")+"' class='img-fluid'>");
                out.println("<p>"+rsmo.getString("goodname")+"</p>");
                out.println("</a>");
                out.println("</form>");
                out.println("</div>");
            }
        %>
            <div class="hot_box_product">
              <!--<img src="img/man/m-11.jpg" class="img-fluid">
              <p>品名</p>
            </div>
            <div class="hot_box_product">
              <img src="img/man/m-12.jpg" class="img-fluid">
              <p>品名</p>
            </div>
            <div class="hot_box_product">
              <img src="img/man/m-13.jpg" class="img-fluid">
              <p>品名</p>
            </div>
            <div class="hot_box_product">
              <img src="img/man/m-14.jpg" class="img-fluid">
              <p>品名</p>
            </div>-->
