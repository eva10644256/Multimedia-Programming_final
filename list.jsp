  ...
  <div class="firm_editor">
    <form>
      <table border="1" style="margin:auto">
        ...
        while(rs.next()){
          out.println("<tr>");
          out.println("<td>"+rs.getString("goodID") +"</td>");
          out.println("<td>"+rs.getString("goodname")+"</td>");
          out.println("<td>"+rs.getString("price")+"</td>");
          out.println("<td>"+rs.getString("quan")+"</td>");
          out.println("<td>"+rs.getString("type")+"</td>");
          out.println("<td>"+rs.getString("kind")+"</td>");
          out.println("<form action='removepd.jsp' method='post'>");
          out.println("<input type='hidden' value='"+rs.getString("goodID")+"' name='pdid'>");
          out.println("<td><button type='submit'>下架</button></td>");
          out.println("</form>");
          out.println("</tr>");
        }
